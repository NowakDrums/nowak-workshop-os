...
## v7.9.7 — simplified completion lifecycle

- Clicking the highlighted Complete button asks whether to move the drum back into production.
- The separate Back to Production button has been removed.
